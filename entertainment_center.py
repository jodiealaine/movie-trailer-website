...
blue_jasmine = movies.Movie("Blue Jasmine", 
...
hunger_games = movies.Movie("Hunger Games",
...
kill_bill = movies.Movie("Kill Bill",
...
crouching_tiger_hidden_dragon = movies.Movie("Crouching Tiger, Hidden Dragon",
